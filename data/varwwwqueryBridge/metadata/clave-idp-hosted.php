...
$claveMeta['__DYNAMIC:1__'] = array(
    ...
    //Unique identifier
    'entityID' => 'http://this.idp.entity.id/',
    
    //Auth Source
    //'auth' => 'clave', //This bridges to the eIDAS SP
    'auth' => 'esmo', //This bridges to the ESMO microservice SP interface
    ...
    //used
    'issuer' => 'http://this.idp.entity.id/',
    ...
    'idp.post.allowed'  => array('forzar','mostrarA','mostrarStork',
                           'mostrarSS','mostrarAEAT','forcedIdP','idpList',
                           'excludedIdPList','allowLegalPerson','country',
                           'postLocationUrl','redirectLocationUrl','RelayState',
                           'sendmethods'),
    ...
    'hostedSP' => 'preprod', // TODO: extinguish from here, it is defined in the authsource and that one should be used
);